...
function onFormSubmission(e) {
    ...
    postToCartoDB(
        ...
        e.namedValues.image,
        e.namedValues.ref_organization,
        loc.lat,
        loc.lng
    );
}
 ...
 */
function postToCartoDB(location,displayname,city,description,timestamp,website,name,email,state_province,zip,country,type,size,youtube,image,ref_organization,latitude,longitude) {
     ...
     */
    var query = "INSERT INTO mpgc_users_submitted(location,displayname,city,description,timestamp,website,name,email,state_province,zip,country,type,size,youtube,image,ref_organization,the_geom) VALUES('"+location+"','"+displayname+"','"+city+"','"+description+"','"+timestamp+"','"+website+"','"+name+"','"+email+"','"+state_province+"','"+zip+"','"+country+"','"+type+"','"+size+"','"+youtube+"','"+image+"','"+ref_organization+"',"+loc+")";

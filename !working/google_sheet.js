 ...
 */
function postToCartoDB(location,displayname,city,description,timestamp,website,name,email,street,state_province, zip,country,type,size,youtube,number,image,latitude,longitude) {
     ...
     */
    var query = "INSERT INTO mpgc_users_submitted(location,displayname,city,description,timestamp,website,name,email,street,state_province,zip,country,type,size,youtube,number,image,the_geom) VALUES('"+location+"','"+displayname+"','"+city+"','"+description+"','"+timestamp+"','"+website+"','"+name+"','"+email+"','"+street+"','"+state_province+"','"+zip+"','"+country+"','"+type+"','"+size+"','"+youtube+"','"+number+"','"+image+"',"+loc+")";

        ...
        <div class="row">
            <div class="col-md-8" style="padding-bottom:50px">
               ...
               <div class="google-form">
                   ...
                   <form action="https://docs.google.com/a/pollinator.org/forms/d/1SxqxTxf50Ud0pMzEZc2CgGdDUCrCfSwldpLi-wObr5w/formResponse" method="post" target="hidden_iframe" onsubmit="submitted=true;" enctype="multipart/form-data">
                       ...
                       <form class="input-group" action="register_new_upload.php"  method="post" enctype="multipart/form-data">

                           Select Image:
                           <input type="file" name="image">
                           <input type="submit" name="upload" value="Upload Now" id="upload">

                       </form>

                       <!-- END SECOND IMAGE UPLOAD-->

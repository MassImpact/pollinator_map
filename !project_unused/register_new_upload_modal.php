            ...
            <div class="col-md-8" style="padding-bottom:50px">
               ...
               <div class="google-form">
                       ...
                       <div class="modal-dialog" role="document">
                           <div class="modal-content">
                               ...
                               <div class="modal-body">
                                   <form action="../register_updated.php"  method="post" enctype="multipart/form-data">
                   ...
                   if(isset($_POST['upload'])){
                       ...
                       echo "<div id='div1'><input type='text' name='entry.1958133231' value='photos/$image_name' class='ss-q-short' id='entry_1958133231' dir='auto' aria-label='Youtube URL ie'></div>";
